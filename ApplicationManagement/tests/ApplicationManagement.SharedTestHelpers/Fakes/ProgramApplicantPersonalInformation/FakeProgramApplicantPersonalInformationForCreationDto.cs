...
public sealed class FakeProgramApplicantPersonalInformationForCreationDto : AutoFaker<ProgramApplicantPersonalInformationForCreationDto>
{
    public FakeProgramApplicantPersonalInformationForCreationDto()
    {
    }
}