...
public class TestingWebApplicationFactory : WebApplicationFactory<Program>, IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        Environment.SetEnvironmentVariable($"{ConnectionStringOptions.SectionName}__{ConnectionStringOptions.ApplicationManagementKey}", _dbContainer.GetConnectionString());
