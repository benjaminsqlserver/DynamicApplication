namespace ApplicationManagement.IntegrationTests;

using ApplicationManagement.Extensions.Services;
using ApplicationManagement.Databases;
using ApplicationManagement.Resources;
using ApplicationManagement.SharedTestHelpers.Utilities;
...
public class TestFixture : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        builder.Configuration.GetSection(ConnectionStringOptions.SectionName)[ConnectionStringOptions.ApplicationManagementKey] = _dbContainer.GetConnectionString();
    ...
    private static async Task RunMigration(string connectionString)
    {
        var options = new DbContextOptionsBuilder<ApplicationDbContext>()
            ...
            .Options;
        var context = new ApplicationDbContext(options, null, null, null);
