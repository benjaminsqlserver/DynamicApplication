...
public sealed class DropdownChoiceQuestionConfiguration : IEntityTypeConfiguration<DropdownChoiceQuestion>
{
    /// <summary>
    /// The database configuration for DropdownChoiceQuestions. 
    /// </summary>
    public void Configure(EntityTypeBuilder<DropdownChoiceQuestion> builder)
    {
